...
class CreditCardAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Fees & Taxes", {"fields": ("fx_fee_percent", "iof_percent")}),
...
class FixedPaymentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Schedule", {"fields": ("frequency", "start_date", "end_date")}),
        ("Status", {"fields": ("is_active",)}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
...
class VariablePaymentAdmin(admin.ModelAdmin):
    list_display = [
        ...
        "category",
        "linked_credit_card",
        "total_amount_with_fees_display",
    ]
    ...
    fieldsets = (
        ...
        ("Credit Card", {"fields": ("linked_credit_card", "credit_card")}),
        (
            "Fees (Auto-calculated)",
            {"fields": ("fx_fee_amount", "iof_amount"), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
...
class UserFinancialProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Profile Information", {"fields": ("name", "base_currency")}),
        ("Monthly Income", {"fields": ("monthly_income_brl", "monthly_income_eur")}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class PaymentStatusInline(admin.TabularInline):
    ...
    def payment_type_display(self, obj):
        """Display the derived payment type."""
...
class CreditCardInvoiceAdmin(admin.ModelAdmin):
    list_display = [
        ...
        "purchases_count_display",
    ]
    list_filter = ["credit_card", "is_closed", "start_date", "end_date"]
    ...
    def get_queryset(self, request):
        ...
        return (
            ...
            .prefetch_related("payment_statuses")
        )
...
class PaymentStatusAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Payment Tracking", {"fields": ("due_date", "status", "paid_date")}),
        (
            "Amount Information",
